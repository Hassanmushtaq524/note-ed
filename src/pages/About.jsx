  ...
  return (
    <DefaultDisplay>
        <div className='w-[80dvw] flex flex-col gap-6'>
            <h1>About</h1>
            <h2 className='font-bold'>What is NOTE-ed?</h2>
            <p className='w-[60%]'>NOTE-ed is a simple yet powerful platform designed for OWU students to store, organize, and share notes with eachother. The goal is to allow all OWU students to study and prepare better! NOTE-ed makes knowledge more accessible.</p>
            ...
            <h2 className='font-bold'>Why use NOTE-ed?</h2>
